 ...
 */
public class LaporanKeuanganTableModel extends AbstractTableModel{
    private List<LaporanKeuanganData> laporanList;
    private String[] header={"Tanggal","Pemasukan"};

    public LaporanKeuanganTableModel() {
    }

    public LaporanKeuanganTableModel(List<LaporanKeuanganData> laporanList) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        //To change body of generated methods, choose Tools | Templates.
        if(columnIndex==0){
            return laporanList.get(rowIndex).getTanggal();
        }
