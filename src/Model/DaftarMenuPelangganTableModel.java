 ...
 */
public class DaftarMenuPelangganTableModel extends AbstractTableModel{
    
    private List<DaftarMenuData> menuList;
    private String[] header={"Nama","Harga","Jumlah","Status"};

    public DaftarMenuPelangganTableModel(List<DaftarMenuData> menuList) {
