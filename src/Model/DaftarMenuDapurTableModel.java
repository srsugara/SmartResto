 ...
 * @author dilaaaaaaa
 */
public class DaftarMenuDapurTableModel extends AbstractTableModel {
    private List<DaftarMenuData> menuList;
    private String[] header={"Nama","Harga","Status"};

    public DaftarMenuDapurTableModel(List<DaftarMenuData> menuList) {
